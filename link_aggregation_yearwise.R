...
for(i in 1:nrow(college_links)){
  ...
  #college_name
  tryCatch({
    table_enrollment<-readHTMLTable(as.character(url_enrollment),which = 1)
    ...
    dir.create(file.path('/Users/shwetha/Documents/R_scraping/enrollment', college_name), showWarnings = FALSE)
    setwd(file.path('/Users/shwetha/Documents/R_scraping/enrollment', college_name))
...
for(i in 1:nrow(college_links_2017)){
  ...
  tryCatch({
    ...
    desired_data_take2<-cbind(desired_data_take2,women_coll)
    View(desired_data_take2)
    setwd('/Users/shwetha/Documents/R_scraping/enrollment/desired_output_collegepond_2018/')
    #write.csv(desired_data_take2,file = paste(college_name,'_output.csv',sep = ''))
    dir.create(file.path('/Users/shwetha/Documents/R_scraping/enrollment/', college_name), showWarnings = FALSE)
    setwd(file.path('/Users/shwetha/Documents/R_scraping/enrollment/', college_name))
